...
//PROMT: [ChatGBT] create toSlug ts arrow function that convert text to lowercase, remove non-word, non-whitespace, non-hyphen characters,replace whitespace,
...
export const formatDateTime = (dateString: Date) => {
  const dateTimeOptions: Intl.DateTimeFormatOptions = {
    ...
    year: 'numeric', //abbreviated month name (e.g., "Sep")
    day: 'numeric', //numeric day (e.g., "9")
    hour: 'numeric', //numeric hour (e.g., "9")
    minute: 'numeric', //numeric minute (e.g., "9")
    hour12: true, // 12-hour clock
  }

  const dateOptions: Intl.DateTimeFormatOptions = {
    //weekday: "short", //abbreviated weekday name (e.g., "Sunday")
    month: 'short', //abbreviated month name (e.g., "Sep")
