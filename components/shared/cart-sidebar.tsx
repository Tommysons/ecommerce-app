...
import { FREE_SHIPPING_MIN_PRICE } from '@/lib/constats'
  ...
  return (
    <div className='w-36 overflow-auto'>
      <div className={`fixed border-l h-full`}>
        <div className='p-2 h-full flex flex-col gap-2 justify-start items-start'>
          <div className='text-center space-y-2'>
            ...
            {itemsPrice > FREE_SHIPPING_MIN_PRICE && (
              <div className='text-center text-xs'>
                You order qualifies for FREE Shipping
              </div>
            )}
